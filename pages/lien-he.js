        ...
        <LienHeStyles>
          <div className="form-wrapper">
            ...
            <div className="right">
              ...
              <FormControl>
                <InputLabel htmlFor="number">Số Điện thoại</InputLabel>
                <Input
                  style={{ width: "80%" }}
                  id="number"
                  aria-describedby="my-helper-text"
              ...
              <FormControl>
                ...
                <TextareaAutosize id="content" style={{ width: "80%" }} aria-label="minimum height" rowsMin={3} placeholder="Nội dung" />
              </FormControl>
              <FormControl>
                <Button
                  variant="contained"
